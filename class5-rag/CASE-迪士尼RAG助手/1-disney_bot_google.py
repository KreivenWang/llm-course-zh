...
1. 安装所有必需的 Python 库:
   pip install google-generative-ai "faiss-cpu" python-docx PyMuPDF Pillow paddleocr transformers torch requests

2. 设置环境变量:
   - GOOGLE_API_KEY: 您从 Google Cloud Console 获取的 API Key。
...
if not GOOGLE_API_KEY:
    raise ValueError("错误：请设置 'GOOGLE_API_KEY' 环境变量。")
